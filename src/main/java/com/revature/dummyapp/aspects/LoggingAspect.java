...
public class LoggingAspect {
	...
	public Object logAdvice(ProceedingJoinPoint joinpoint) throws Throwable {
		...
		// this creates a logger for the class
	...
	// in order to make a reusable pointcut expression, we can use a hook method
	// (method with an empty body used to hold annotations)
	@Pointcut("execution(* com.revature.dummyapp..*(..) )")
	public void allDummyApp() {}
